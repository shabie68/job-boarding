			...
			<div className="gorgeous-mt-70">
				<div>
					...
					{role == 1 && !hasCompany?
				  	...
				  	<div className="">
						<div className="d-grid my-4 gap-4 bj-grid-col-3 bj-rows-auto">
							...
							{companies?.map(company => (
								 ...
								 <div className="bg-one bj-border-radius bj-p-20 bj-border bj-w-fit-content rounded bj-cursor-pointer bj-company-container"  key={"company--"+company.id} onClick={() => {singleCompany(company)}}>
									<div className="h-100 d-flex gap-4 align-items-center" >
									  ...
									  <div className="w-75">
									  	<h3 className="bj-font-cursive">{company.title}</h3>
										 <div className="">
											<p>{company.title}</p>
										 </div>
									  ...
									  <div className="modal-dialog">
										<div className="modal-content">
										  ...
										  <div className="modal-footer">
											<button type="button" className="btn bg-two text-prime" data-bs-dismiss="modal">Cancel</button>
											<button type="button" id={'company-' +company.id} className="btn bg-three text-prime" onClick={() => {document.querySelector(`#company-${company.id}`).setAttribute('data-bs-dismiss', 'modal'); addReview(company.id)}}>Add review</button>
										  </div>
										</div>
									  </div>
									</div>
				  	...
				  	<div className="d-flex gap-2 align-items-center gorgeous-mb-16">
