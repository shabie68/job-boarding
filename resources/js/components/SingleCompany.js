						...
						<div>
										<div className="d-flex justify-content-between">
											...
											<div style={{cursor: 'pointer'}} className="text-center">
												...
												<span onClick={() => {setRating(true);setFeedback({...feedback, rating: 3})}} style={{color: 'blue'}}>
												...
												<span onClick={() => {setRating(true);setFeedback({...feedback, rating: 4})}} style={{color: 'blue'}}>
												...
												<span onClick={() => {setRating(true);setFeedback({...feedback, rating: 5})}} style={{color: 'blue'}}>
										...
										{
											!rating ?
											<p className="text-danger text-end">Please add rating too</p>
											: ''
										}
					...
					<section>
						<h3 className="text-two">Feedback</h3>
						{
							location?.state?.company.feedback?.map((_feedback, index) => (
								<div key={_feedback.name} className="bj-font-cursive bj-border-prime bj-radius-10 my-4 p-4">
									...
									<p className="my-2 bj-w-66">{_feedback.comment}</p>
								</div>
							))
						}
