  ...
  return (
    <div className="my-4">
      <div className="d-flex gap-2 align-items-center gorgeous-mb-8">
        <Link to="/home">
          <svg style={{ color: 'black', verticalAlign: 'middle'}} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
      ...
      <section className="gorgeous-card">
